...
// #include "actor_version/console.h"
// static ecsfrm::Logger::ptr g_logger = ecsfrm::LogSystemUtil::RegisterLogger("App");
#include "actor_version/server_app.h"
int main(int argc, char **argv)
{
    return ecsfrm::MainTemplate<ecsfrm::ServerApp>(argc, argv);
    // ecsfrm::Cmd2Func::CreateInstance();
    ...
    // ecsfrm::ThreadMgr::GetInstance()->PushActor(new ecsfrm::Console());
